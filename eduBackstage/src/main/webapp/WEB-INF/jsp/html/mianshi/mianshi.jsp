		...
		$('#dg').datagrid({    
		 ...
		 //"stuName":"张三","ZHUANGTAI":1,"stuSex":"男","stuTel":"138888","ms_jieguo":1,"ms_gongzi":12000,"stuIntent":"JAVA"}
		   columns:[[    
		        ...
		        {field:'ms_gongsi',title:'面试公司',width:100},
		        {field:'ms_gongzi',title:'期望工资',width:100},
		        {field:'ms_shijian',title:'面试时间',width:100,formatter:function(value){
		        	if(value){
		        		//时间戳转化为date类型
		        ...
		        {field:'ms_jieguo',title:'面试结果',width:100, formatter:function(msJieguo){
		        	if(msJieguo=="1"){
		        		return "录取"
		        	}else{
		        		return "待定"
